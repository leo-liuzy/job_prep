...
class GRPOLoss(nn.Module):
    ...
    def forward(
        ...
        ratio = (log_probs - old_log_probs).exp() # # shape: (num_rollouts, sequence_length)
        surr1 = ratio * advantages #  (num_rollouts, sequence_length) * (num_rollouts, 1)
